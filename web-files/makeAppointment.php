    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarColor02">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="createTestAppointment.php">View Appointments</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class = "container">
            <div class = "jumbotron">
                ...
                <form class method = "GET" action = "createTestAppointment.php" onsubmit="return checkPassword(this)">
                    <div class = "mb-3">
